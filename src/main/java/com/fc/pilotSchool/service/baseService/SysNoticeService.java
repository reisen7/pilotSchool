...
import com.fc.pilotSchool.mapper.auto.SysNoticeMapper;
import com.fc.pilotSchool.mapper.auto.SysNoticeUserMapper;
import com.fc.pilotSchool.model.auto.SysNotice;
import com.fc.pilotSchool.model.auto.SysNoticeExample;
import com.fc.pilotSchool.model.auto.SysNoticeUser;
import com.fc.pilotSchool.model.auto.SysNoticeUserExample;
import com.fc.pilotSchool.model.auto.SysNoticeUserExample.Criteria;
import com.fc.pilotSchool.model.auto.TsysUser;
import com.fc.pilotSchool.model.auto.TsysUserExample;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.fc.pilotSchool.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
