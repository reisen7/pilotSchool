...
public class MybatisAutoGenerator {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/springbootv2?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC", "root", "root")
                // 全局配置
                .globalConfig(builder -> builder.outputDir(pkgPath).author("pilotSchool")
                        .fileOverride().disableOpenDir())
                // 包配置
                .packageConfig(builder -> builder.parent("com.fc.pilotSchool").entity("model.auto").mapper("mapper.auto").service("service.plus")
...
//                        other;
                        ...
                        map.put(OutputFile.entity,outPath+"\\src\\main\\java\\com\\fc\\pilotSchool\\model\\auto");
                        map.put(OutputFile.service,outPath+"\\src\\main\\java\\com\\fc\\pilotSchool\\service\\plus");
                        map.put(OutputFile.serviceImpl,outPath+"\\src\\main\\java\\com\\fc\\pilotSchool\\service\\plus\\impl");
                        map.put(OutputFile.mapper,outPath+"\\src\\main\\java\\com\\fc\\pilotSchool\\mapper\\auto");
