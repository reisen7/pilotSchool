...
public class StaffExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andWagesNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(Staff record) {
			...
			if(record.getStaffCard()!=null&&StrUtil.isNotEmpty(record.getStaffCard().toString())) {
    			 list.add("ifnull(staff_card,'')");
    		}
