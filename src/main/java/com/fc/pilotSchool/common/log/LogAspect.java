package com.fc.pilotSchool.common.log;
...
import com.fc.pilotSchool.service.baseService.SysOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.fc.pilotSchool.common.log.Log)")
